...
# Timings follow the action: rings presented -> naming colours -> following
# instructions -> largest ring first -> size ordering -> fine motor -> turn
# taking -> finished tower.
# ---------------------------------------------------------------------------
CAPTIONS = [
    (4.8, 9.4, "اللعب هو أسرع طريق", "لتعلّم الطفل"),
    (9.6, 14.2, "بنسمّي كل لون مع الطفل", "أحمر.. أصفر.. أخضر.. أزرق"),
    (14.4, 19.0, "وبينفّذ التعليمات", "خطوة بخطوة"),
    (19.2, 24.0, "نبدأ بالحلقة الأكبر", "وبعدين الأصغر فالأصغر"),
    (24.2, 29.0, "ترتيب الأحجام", "بيقوّي الإدراك والتركيز"),
    (29.2, 34.0, "وكل حلقة تدريب", "للعضلات الدقيقة في الأصابع"),
    (34.2, 38.6, "وكمان بيتعلّم الانتظار", "والتبادل: دوري.. ودورك"),
    (38.8, 43.2, "وأخيرًا.. البرج اكتمل", "نحتفل بكل نجاح صغير"),
]

TITLE_MAIN = "جلسة تخاطب"
TITLE_SUB = "تدريب الألوان والأحجام والتسلسل"
