...
**الناتج:** `output/reel2_facebook.mp4` — ‏1080×1920، ‏30fps، ‏61.6 ثانية.

## اللي اتعمل

| | |
|---|---|
| هدف الجلسة | ٣ شرائح متحركة في أول ١٣ ثانية: تمييز سمعي بصري، تمييز ألوان، عضلات دقيقة |
| الكابشن | ‏6 جمل متزامنة مع مراحل التدريب |
| الصوت | **صوت الأخصائية متسيب** — وده الدليل على هدف التمييز السمعي |
| المزيكا | بتهدى أوتوماتيك تحت الكلام (sidechain ducking) |
| النهاية | كارت حجز فيه اسم المركز والتليفون والعنوان |
| الحركة | زووم بطيء داخل الكادر، والكابشن ثابت فوقه |
| الإيقاع | تسريع ‏1.3× مع `atempo` — بيحافظ على طبقة الصوت الطبيعية |
| الصوت النهائي | ‏-15.1 LUFS و ‏-1.6 dBFS |
...
**صوت الأخصائية اتساب عن قصد** لأنه الدليل المسموع على التمييز السمعي.
اتعمله تنضيف: فلتر للرنة، تقليل ضوضاء، وضغط خفيف عشان التعليمات الهادية تبان تحت المزيكا.
مقدرتش أسمع الكلام وأفرّغه، فالكابشن بيوصف النشاط والأهداف اللي إنتي حدّتيها، مش بينقل كلام حرفي.

## الكابشن الجاهز للنشر

> طفلك بيعرف يميّز الألوان؟ بيفهم لما تطلبي منه حاجة؟ 🤔
>
> في الفيديو ده تدريب واحد بيشتغل على ٣ مهارات مع بعض:
> ✅ تمييز سمعي بصري — يسمع التعليمات وينفّذها
